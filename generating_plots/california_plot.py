...
def compute_sketch_size_vs_error(A, b, k_range = [60, 80, 100, 125, 250, 500], loops = 20,\
...
def plot_sketch_size_vs_error(A, b, k_range, loops = 20,\
    ...
    for key in sketching_matrix_function_dict:
        print(key)
        results = compute_sketch_size_vs_error(A, b, k_range, loops, sketching_matrix_function_dict[key], SVD=SVD, compute_residual=compute_residual)
...
def plot_sketch_size_vs_error_california(loops = 20, k_range = range(50, 1000, 20), compute_residual=True):
    ...
    plot_sketch_size_vs_error(A=A, b=b,\
