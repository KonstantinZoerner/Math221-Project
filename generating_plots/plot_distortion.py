...
def plot_sketch_size_vs_distortion(m = 1000, n = 50, k_range = [60, 80, 100, 125, 250, 500], loops = 5):
    results_orth = compute_sketch_size_vs_distortion(m, n, k_range, loops, sketching.sketch_orthogonal)
    #results_gaussian = compute_sketch_size_vs_distortion(m, n, k_range, loops, sketching.gaussian_sketching_matrix)
    #results_hadamard = compute_sketch_size_vs_error(m, n, k_range, loops, sketching.hadamard_sketch_matrix)
    #results_uniform = compute_sketch_size_vs_distortion(m, n, k_range, loops, sketching.uniform_sketching_matrix)
    ...
    plt.title("Sketch size vs distortion (m = 1000, n = 50)")
